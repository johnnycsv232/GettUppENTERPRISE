...
import { Body, GlassCard, H1, MagneticButton } from "@/components/ui";
					...
					<ul className="space-y-4">
						<li className="flex gap-3">
							...
							<div>
								...
								<p className="text-sm text-gray-400">
									You&apos;ll receive a confirmation with your receipt and next
									steps.
								</p>
							</div>
						</li>
						<li className="flex gap-3">
							...
							<div>
								...
								<p className="text-sm text-gray-400">
									We&apos;ll reach out within 24 hours to confirm your preferred
									date.
								</p>
							</div>
						</li>
