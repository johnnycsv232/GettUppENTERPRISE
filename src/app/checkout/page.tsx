/**
 * @file page.tsx
 * @description Checkout page - Initiates Stripe checkout session
 * @module app/checkout
 */
...
import { getTier, PRICING_TIERS, TierId } from "@/lib/constants/pricing";
...
function CheckoutContent() {
	...
	const tier =
		tierParam && PRICING_TIERS[tierParam] ? getTier(tierParam) : null;
					...
					<div className="space-y-6">
						<GlassCard>
							...
							<p className="text-gray-300 mb-6">
								You will be redirected to Stripe's secure checkout to finalise
								your payment.
							</p>
