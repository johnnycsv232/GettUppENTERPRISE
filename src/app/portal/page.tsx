...
import { 
  Camera, Calendar, Image, CreditCard, Settings, LogOut, 
    ...
    <main className="min-h-screen bg-brand-ink">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="mb-8">
          ...
          <Body className="text-gray-400">Manage your shoots and view your content.</Body>
        </div>
...
function SessionRow({ session }: { session: Session }) {
  const statusConfig = {
    ...
    in_progress: { icon: Camera, color: 'text-yellow-400', label: 'In Progress' },
