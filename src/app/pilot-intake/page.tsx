...
import { AlertTriangle, Calendar, Camera, Check, Clock } from "lucide-react";
...
export default function PilotIntakePage() {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			router.push(
				`/checkout?tier=pilot&email=${encodeURIComponent(validated.email)}`,
			);
		} catch (err) {
			...
			<div className="max-w-4xl mx-auto">
				...
				<div className="text-center mb-8">
					...
					<Body className="text-gray-300 max-w-2xl mx-auto">
						One shoot. 30 photos. 72-hour delivery. Prove we deliver before you
						commit.
					</Body>
				</div>
						...
						<GlassCard>
							<form onSubmit={handleSubmit} className="space-y-6">
								...
								>
									{isSubmitting
										? "Processing..."
										: `Claim Your Pilot - ${pilot.priceDisplay}`}
								</MagneticButton>
