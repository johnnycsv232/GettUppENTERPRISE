...
import { 
  TrendingUp, TrendingDown, DollarSign, Users, Camera, 
  Eye, Calendar, ArrowUpRight, Terminal, RefreshCw 
} from 'lucide-react';
...
const CONVERSION_FUNNEL = [
  ...
  { stage: 'Converted to Retainer', count: 24, color: 'bg-[var(--brand-gold)]' },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <Body className="text-gray-400 mt-1">Track revenue, conversions, and engagement</Body>
          </div>
          <div className="flex gap-3">
            ...
            <MagneticButton variant="outline" onClick={handleRefresh} disabled={refreshing}>
                ...
                {REVENUE_DATA.map(data => (
                  <div key={data.month} className="flex-1 flex flex-col items-center">
                    <div className="w-full flex flex-col items-center">
                      <span className="text-xs text-gray-400 mb-1">${data.mrr}</span>
                      <div 
            ...
            <GlassCard>
              ...
              <div className="space-y-4">
                {CONVERSION_FUNNEL.map((stage, idx) => {
                  const width = (stage.count / CONVERSION_FUNNEL[0].count) * 100;
                  return (
                    <div key={stage.stage}>
                      ...
                      {idx < CONVERSION_FUNNEL.length - 1 && (
                        <div className="flex justify-end mt-1">
                          <span className="text-xs text-gray-500">
                            {((CONVERSION_FUNNEL[idx + 1].count / stage.count) * 100).toFixed(1)}% →
                          </span>
                        </div>
                      )}
                    </div>
        ...
        <GlassCard className="mt-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <a href="/admin/clients" className="text-sm text-[var(--brand-gold)] hover:underline flex items-center gap-1">
        ...
        <GlassCard className="mt-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-lg font-semibold text-white">Analytics CLI Commands</h3>
          </div>
          <div className="grid md:grid-cols-3 gap-4 text-sm font-mono">
            ...
            <div className="p-3 bg-black/30 rounded-lg">
              ...
              <code className="text-[var(--brand-gold)]">stripe payments list --limit 10</code>
            </div>
            <div className="p-3 bg-black/30 rounded-lg">
              <p className="text-gray-400 mb-1"># Firebase analytics export</p>
              <code className="text-[var(--brand-gold)]">firebase analytics:export</code>
            </div>
          </div>
        </GlassCard>
      </div>
