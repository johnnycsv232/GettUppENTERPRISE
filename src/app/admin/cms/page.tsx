...
import { FileText, Image, Video, Save, Eye, RefreshCw, Terminal } from 'lucide-react';
...
const CONTENT_BLOCKS: ContentBlock[] = [
  ...
  },
  {
    ...
    content: {
      ...
      subheadline: 'Pilot night proves it works. These are the subscription engines that keep your weekends heavy.',
    },
    lastUpdated: '2024-12-01',
  },
  {
    ...
    content: {
      ...
      subheadline: 'Lock in a pilot night and see what happens when your content finally matches the energy inside your venue.',
    ...
    try {
      ...
      setBlocks(prev => prev.map(b => 
        b.id === selectedBlock.id 
          ? { ...b, content: editedContent, lastUpdated: new Date().toISOString().split('T')[0] }
          : b
      ));
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <Body className="text-gray-400 mt-1">Edit landing page content and marketing copy</Body>
          </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-3">
            <h3 className="text-lg font-semibold text-white mb-4">Content Blocks</h3>
            {blocks.map(block => (
              <button
                key={block.id}
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">Updated: {block.lastUpdated}</p>
                  </div>
                </div>
              </button>
            ))}
          ...
          <div className="lg:col-span-2">
            {selectedBlock ? (
              <GlassCard>
                ...
                {lastSync && (
                  <p className="text-sm text-green-400 mt-4">✅ Last saved: {lastSync}</p>
                )}
              </GlassCard>
            ) : (
        ...
        <GlassCard className="mt-8">
          ...
          <div className="grid md:grid-cols-3 gap-4 text-sm font-mono">
            <div className="p-3 bg-black/30 rounded-lg">
              ...
              <code className="text-[var(--brand-gold)]">firebase deploy --only firestore</code>
            </div>
            <div className="p-3 bg-black/30 rounded-lg">
