...
const HeroScene = dynamic(() => import("@/components/three/HeroScene"), {
	ssr: false,
	loading: () => (
		<div className="absolute inset-0 bg-gradient-to-br from-[var(--brand-ink)] to-black" />
	),
});
	...
	return (
		<section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[var(--brand-ink)]">
			...
			>
				...
				>
					Premium nightlife photography run like an operations system—so your
					room fills up every weekend, not just on lucky Fridays.
				</motion.p>
				...
				>
					<ProofChip
						...
						text="79.7K views (90 days)"
					/>
					<ProofChip
						icon={<Clock className="w-4 h-4" />}
						text="24-72h delivery"
					/>
					<ProofChip
						icon={<MapPin className="w-4 h-4" />}
						text="Minneapolis specialist"
					/>
				</motion.div>
