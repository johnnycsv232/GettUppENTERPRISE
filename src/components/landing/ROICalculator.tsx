...
const roiPoints = [
	{
		...
		desc: "to cover VIP tier cost",
	},
	{
		icon: <DollarSign />,
		value: 350,
		prefix: "$",
		label: "Avg LTV Per Regular",
		desc: "lifetime value each",
	},
	{
		icon: <TrendingUp />,
		value: 1050,
...
export function ROICalculator() {
	...
	return (
		<section
			ref={ref}
			className="py-32 px-6 bg-gradient-to-b from-brand-ink via-brand-surface to-brand-ink relative overflow-hidden"
		>
			{/* Background */}
				...
				<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
					{roiPoints.map((point, i) => (
						...
						>
							...
							<div className="text-[#D9AE43] font-semibold mb-1">
								{point.label}
							</div>
						...
						<div className="grid lg:grid-cols-2 gap-12 items-center">
							...
							<div>
								...
								<ul className="space-y-4">
									{[
										{
											text: "3 new regulars × $350 lifetime value",
											result: "$1,050",
										},
