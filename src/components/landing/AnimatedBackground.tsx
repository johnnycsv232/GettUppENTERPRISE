    ...
    <div className="absolute inset-0 z-0 overflow-hidden bg-[#0B0B0D]">
      ...
      <svg className="absolute inset-0 w-full h-full opacity-20" preserveAspectRatio="none" viewBox="0 0 1920 1080">
        ...
        <motion.path
          ...
          initial={{ pathLength: 0, opacity: 0 }}
          animate={{ pathLength: 1, opacity: 1 }}
          transition={{ duration: 5, delay: 1, ease: "easeInOut", repeat: Infinity, repeatType: "loop", repeatDelay: 3 }}
        />
        <motion.path
          ...
          initial={{ pathLength: 0, opacity: 0 }}
          animate={{ pathLength: 1, opacity: 1 }}
          transition={{ duration: 6, delay: 2, ease: "easeInOut", repeat: Infinity, repeatType: "loop", repeatDelay: 4 }}
        />
      </svg>
      ...
      <motion.div
        ...
        style={{
          background: 'linear-gradient(135deg, rgba(217, 174, 67, 0.12) 0%, rgba(217, 174, 67, 0.02) 100%)',
      ...
      <motion.div
        ...
        style={{
          background: 'linear-gradient(135deg, rgba(255, 60, 147, 0.1) 0%, rgba(255, 60, 147, 0.01) 100%)',
      ...
      <motion.div
        ...
        style={{
          background: 'radial-gradient(circle, rgba(217, 174, 67, 0.15) 0%, transparent 50%)',
        }}
      />

      {/* Energy waves - expanding rings */}
      {mounted && waves.map((wave) => (
        <motion.div
          key={wave.id}
