...
import { Camera, Check, Clock, Sparkles, Video } from "lucide-react";
					...
					{TIERS.map((tier) => (
						...
						>
							...
							<div className="text-center mb-6">
								<p className="text-sm text-[var(--brand-gold)] font-medium mb-2">
									{tier.tagline}
								</p>
								...
								<div className="flex items-baseline justify-center gap-1">
									<span className="text-4xl font-bold text-[var(--brand-gold)]">
										${tier.price}
									</span>
