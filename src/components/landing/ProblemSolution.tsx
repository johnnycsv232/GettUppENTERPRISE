...
export function ProblemSolution() {
  ...
  return (
    <section ref={ref} className="py-0 relative overflow-hidden flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 bg-[#050505] py-24 px-8 md:px-16 relative border-r border-white/5">
        <div className="max-w-lg ml-auto">
          ...
          <h3 className="font-heading text-4xl font-bold text-white mb-12">
            TIRED OF CONTENT THAT <span className="text-[#FF3C93] line-through decoration-2">GHOSTS YOU?</span>
          </h3>
