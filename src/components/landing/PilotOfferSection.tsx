			...
			<div className="max-w-5xl mx-auto relative">
				...
				>
					...
					<p className="text-xl text-gray-300 max-w-2xl mx-auto">
						One night. One shoot. Thirty edited photos. No subscription. Just
						proof that this engine moves bodies, not just numbers on a post.
					</p>
				</motion.div>
						...
						<div>
							...
							<div className="mb-8">
								<div className="flex items-baseline gap-2">
									<span className="text-6xl md:text-7xl font-bold text-[var(--brand-gold)]">
										$345
									</span>
						...
						<div className="text-center md:text-left">
							...
							<div className="mb-6 p-4 rounded-lg bg-white/5 border border-white/10">
								<p className="text-sm text-gray-300">
									...
									opened each month to protect delivery quality.
								</p>
							</div>
							...
							<div className="mt-6 flex items-start gap-3 p-4 rounded-lg bg-green-500/10 border border-green-500/30">
								...
								<div className="text-left">
									...
									<p className="text-xs text-gray-300">
										If we don't move the needle on covers in 60 days, you get a
										full refund and an extra shoot on us.
									</p>
								</div>
							</div>
