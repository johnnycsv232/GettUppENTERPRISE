      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto">
            Your nights aren't judged on likes—they're judged on doors, covers, and who comes back 
            next week. The GettUpp ShotClock system tracks campaigns from "post is live" to "line 
            at the door," so you can see exactly which content pulls its weight.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {ROI_DATA.map((item, idx) => (
            <ROICard key={item.label} {...item} delay={idx * 0.1} inView={isInView} />
          ))}
        </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-center gap-3">
                  ...
                  3 new regulars at $350 lifetime value = <span className="text-[var(--brand-gold)] font-bold">$1,050</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-[var(--brand-gold)] rounded-full" />
                  Covers $995 VIP tier for <span className="text-[var(--brand-gold)] font-bold">one month</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-[var(--brand-gold)] rounded-full" />
                  One VIP table night (~$3K) covers <span className="text-[var(--brand-gold)] font-bold">~3 months</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-[var(--brand-gold)] rounded-full" />
                  Pilot breaks down to <span className="text-[var(--brand-gold)] font-bold">~$11/photo</span>
                </li>
              </ul>
            </div>
            ...
            <div>
              <div className="mb-4">
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="text-[var(--brand-gold)] font-bold">$995/mo</span>
                </div>
...
function ROICard({ icon, value, suffix = '', prefix = '', label, description, delay, inView }: ROICardProps) {
