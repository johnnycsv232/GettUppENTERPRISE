...
const stats = [
  ...
  { icon: <Target className="w-5 h-5" />, value: '95%', label: 'On-Time Delivery' },
];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="aspect-[4/5] rounded-2xl bg-gradient-to-br from-[var(--brand-gold)]/20 to-[var(--brand-pink)]/20 border border-[var(--brand-gold)]/30 overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-[var(--brand-gold)] font-bold text-xl">JOHNNY CAGE</p>
                  <p className="text-gray-400 text-sm">Founder & Lead Photographer</p>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <p className="text-lg text-gray-300 leading-relaxed mb-6">
              ...
              recognize before they see the camera. Official photographer for Last Call and a fixture 
              at DJ YS sets, he turned "pull up with the homies" access into a system that delivers 
              nightclub-grade content on a 24-72h clock.
            </p>

            <p className="text-lg text-gray-300 leading-relaxed mb-8">
              <span className="text-[var(--brand-gold)] font-semibold">GettUpp ENT</span> is that 
              system—built by the guy who's already in the room, then hardened with an enterprise 
              playbook so your content hits on schedule every time.
            </p>
