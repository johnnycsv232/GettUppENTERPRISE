...
const steps = [
	{
		...
		description:
			"Fill out the quick intake form. We'll confirm your date within 24 hours.",
		color: "#D9AE43",
	},
	{
		...
		title: "WE PULL UP",
		description:
			"Johnny and the team arrive, capture the energy, and document the night.",
		color: "#FF3C93",
	},
	{
		...
		title: "EDIT & DELIVER",
		description:
			"30 club-ready edits delivered in 24-72 hours. Full GettUpp treatment.",
		color: "#D9AE43",
	},
	{
		...
		title: "POST & TRACK",
		description:
			"Get your 7-10 day posting plan. We track from post to door with ShotClock.",
		color: "#FF3C93",
	},
];
