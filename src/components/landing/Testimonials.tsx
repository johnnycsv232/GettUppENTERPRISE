...
const testimonials = [
  {
    ...
    avatar: 'MT',
    content: "Johnny and his team have completely transformed our social presence. We went from getting maybe 50 likes to consistent 500+ engagement on every post. More importantly—weekends are packed now.",
    rating: 5,
  ...
  },
  {
    ...
    avatar: 'YS',
    content: "I've worked with a lot of photographers but GettUpp is different. They understand the energy, they deliver on time, and the content actually builds my brand. No more chasing freelancers.",
    rating: 5,
  ...
  },
  {
    ...
    avatar: 'SK',
    content: "The 24-hour delivery promise isn't marketing BS—they actually deliver. We post while the night is still fresh in people's minds and the engagement reflects it.",
    rating: 5,
  ...
  },
  {
    ...
    role: 'Producer/DJ',
    avatar: 'BD',
    content: "Real talk—GettUpp made my last show look like a festival. Professional content that matches the energy we put into our performances. Worth every dollar.",
    rating: 5,
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Don't take our word for it—hear from venues and artists we've worked with.
          </p>
        </motion.div>
          ...
          <div className="relative bg-gradient-to-br from-[#1a1a1d] to-[#0B0B0D] border border-white/10 rounded-3xl p-8 md:p-12">
            ...
            <div className="relative">
              ...
              <div className="flex gap-1 mb-6">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-6 h-6 text-[#D9AE43] fill-[#D9AE43]" />
                ))}
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="px-4 py-2 bg-[#D9AE43]/20 border border-[#D9AE43]/30 rounded-full">
                  <span className="text-[#D9AE43] font-bold">{testimonials[activeIndex].metric}</span>
                </div>
              </div>
            </div>
          </div>
