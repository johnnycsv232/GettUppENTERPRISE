      ...
      <div className="max-w-5xl mx-auto relative">
        ...
        >
          ...
          >
            ...
            <span className="text-[#D9AE43] font-medium">Only 3 pilot slots per month</span>
          </motion.div>
          ...
          >
            Lock in a pilot night and see what happens when your content 
            finally matches the energy inside your venue.
          </motion.p>
          ...
          >
            <Link href="/pilot-intake">
              <motion.button
                whileHover={{ scale: 1.05, boxShadow: '0 0 60px rgba(217,174,67,0.4)' }}
                whileTap={{ scale: 0.98 }}
