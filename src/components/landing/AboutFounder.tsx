				...
				<div className="grid lg:grid-cols-2 gap-16 items-center">
						...
						<div className="relative aspect-[4/5] rounded-3xl overflow-hidden border-2 border-[#D9AE43]/30 bg-[#1a1a1d]">
							...
							>
								<div className="bg-[#0B0B0D]/80 backdrop-blur-xl rounded-2xl p-4 border border-[#D9AE43]/30">
									<h3 className="font-heading text-2xl font-bold text-[#D9AE43]">
										JOHNNY CAGE
									</h3>
					...
					>
						...
						<div className="space-y-6 text-lg text-gray-300 leading-relaxed mb-10">
							<p>
								<span className="text-[#D9AE43] font-semibold">
									Johnny Cage
								</span>{" "}
								is the lens behind 350+ Minneapolis nights this year and the
								name venues recognize before they see the camera.
							</p>
							<p>
								Official photographer for{" "}
								<span className="text-white font-semibold">Last Call</span> and
								a fixture at{" "}
								<span className="text-white font-semibold">DJ YS</span> sets, he
								turned "pull up with the homies" access into a system that
								delivers nightclub-grade content on a 24-72h clock.
							</p>
							<p>
								<span className="text-[#D9AE43] font-semibold">
									GettUpp ENT
