      ...
      >
        ...
        <div className="relative p-8 flex flex-col flex-grow">
          ...
          <div className="text-[var(--brand-gold)] text-sm font-bold uppercase tracking-wider mb-2">
            {tier.id === 'pilot' ? 'INVITE ONLY' : tier.displayName.toUpperCase()}
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 mb-6 text-center">
            ...
            <div className="bg-white/5 rounded-lg py-2">
              <div className="text-lg font-bold text-white">{tier.delivery}</div>
          ...
          {/* CTA Button */}
          <Link href={tier.id === 'pilot' ? '/pilot-intake' : `/checkout?tier=${tier.id}`}>
            <MagneticButton
