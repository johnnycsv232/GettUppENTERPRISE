...
export function MagneticButton({
	...
	const baseStyles =
		"font-semibold rounded-lg transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2";
	...
	const variantStyles = {
		...
		outline:
			"border-2 border-[var(--brand-gold)] text-[var(--brand-gold)] hover:bg-[var(--brand-gold)] hover:text-[var(--brand-ink)]",
	};
