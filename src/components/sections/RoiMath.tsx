	...
	return (
		<section className="relative py-24 overflow-hidden bg-gradient-to-b from-[var(--brand-ink)] via-[#0B0B0D] to-[var(--brand-ink)]">
			...
			<div className="container mx-auto px-6 relative z-10">
				...
				>
					It takes just{" "}
					<span className="text-brand-gold font-bold">3 New Regulars</span> to
					pay for our highest tier.
					<br />
					Everything else is{" "}
					<span className="text-brand-gold font-bold">profit</span>.
				</motion.p>
